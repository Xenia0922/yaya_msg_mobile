...
const styles = StyleSheet.create({
  ...
  card: { marginHorizontal: 16, marginBottom: 14, padding: 16, backgroundColor: '#FFFFFF', borderRadius: 18 },
  cardDark: { backgroundColor: '#1C1C1F' },
  emptyCard: { marginHorizontal: 16, marginBottom: 14, padding: 18, backgroundColor: '#FFFFFF', borderRadius: 18 },
