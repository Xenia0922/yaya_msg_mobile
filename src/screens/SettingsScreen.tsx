...
const styles = StyleSheet.create({
  ...
  section: { marginHorizontal: 12, marginTop: 8, padding: 14, backgroundColor: '#FFFFFF', borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.66)' },
  sectionDark: { backgroundColor: '#1C1C1F', borderColor: 'rgba(255,255,255,0.10)' },
